    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        ...
        return http
                ...
                .authorizeExchange(auth -> auth
                        ...
                        .pathMatchers(HttpMethod.GET,"/api/auditoria/listar").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.PUT,"/api/cambio/actualizar").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.GET,"/api/usuarios/listar").hasRole("ADMIN")
